...
Aggregate cell types using `aggregate_results()`. The selected deconvolution results are summed and stored under a new name. The aggregation can be visualized with all available plotting functions.

```{r aggregation}
deconv <- spacedeconv::aggregate_results(
  deconv,
  cell_types = c("spatialdwls_Cancer.Epithelial", "spatialdwls_Normal.Epithelial"),
  name = "spatialdwls_Epithelial"
)
```
